...
// node_modules/@marcoschulte/vue3-progress/dist/index.js
var require_dist = __commonJS({
  "node_modules/@marcoschulte/vue3-progress/dist/index.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    var vue = require_vue();
    var holder = { instance: null };
    var injectionKey = Symbol("Vue3Progress");
    var useProgress = () => {
      return holder.instance || vue.inject(injectionKey);
    };
    function trickleComposable(state2) {
    ...
    var script = vue.defineComponent({
      ...
      setup: () => {
        const state2 = useProgress().state();
        const { value } = trickleComposable(state2);
        return { state: state2, value };
      },
      computed: {
        style() {
          return {
...
//# sourceMappingURL=@marcoschulte_vue3-progress.js.map
