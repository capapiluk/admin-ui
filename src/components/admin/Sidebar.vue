  ...
  <div class="vertical-menu">
    ...
    <div class="navbar-brand-box">
      <a href="index.html" class="logo logo-dark">
        ...
        <span class="logo-lg">
          <img src="/assets/images/logo-sm.svg" alt="" height="26" />
          <span class="logo-txt">เยี่ยมบ้าน</span>
        </span>
      </a>
    ...
    <div data-simplebar="init" class="sidebar-menu-scroll">
      <div class="simplebar-wrapper" style="margin: 0px">
              ...
              <div class="simplebar-content" style="padding: 0px">
                ...
                <div id="sidebar-menu">
                  ...
                  <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li :class="{ 'mm-active': isActiveRoute('/') }">
                      <router-link to="/">
                    ...
                    <li :class="{ 'mm-active': isActiveRoute('/product') }">
                    ...
                    <li :class="{ 'mm-active': isActiveRoute('/table') }">
                      <router-link to="/table">
                        <i class="bx bx-chat nav-icon"></i>
                        <span class="menu-item" data-key="t-chat">ตารางสินค้า</span>
                       </router-link>
                    </li>
                    ...
                    <li>
                      <a href="apps-file-manager.html">
                        ...
                        <span class="menu-item" data-key="t-filemanager"
                          >File Manager</span
                        >
                      </a>
                    </li>
                    ...
                    <li>
                      ...
                      <ul class="sub-menu mm-collapse" aria-expanded="false">
                        <li>
                          <a href="email-inbox.html" data-key="t-inbox"
                            >Inbox</a
                          >
                        </li>
                        <li>
                          <a href="email-read.html" data-key="t-read-email"
                            >Read Email</a
                          >
                        </li>
                      </ul>
                    ...
                    <li>
                      ...
                      <ul class="sub-menu mm-collapse" aria-expanded="false">
                        <li>
                          <a href="contacts-grid.html" data-key="t-user-grid"
                            >User Grid</a
                          >
                        </li>
                        <li>
                          <a href="contacts-list.html" data-key="t-user-list"
                            >User List</a
                          >
                        </li>
                        <li>
                    ...
                    <li>
                      <a href="apps-gallery.html">
                        ...
                        <span class="menu-item" data-key="t-gallery"
                          >Gallery</span
                        >
                      </a>
                    </li>
                    ...
                    <li>
                      ...
                      >
                        ...
                        <span class="menu-item" data-key="t-projects"
                          >Projects</span
                        >
                      </a>
                      <ul class="sub-menu mm-collapse" aria-expanded="false">
                        <li>
                          <a href="projects-grid.html" data-key="t-p-grid"
                            >Projects Grid</a
                          >
                        </li>
                        <li>
                          <a href="projects-list.html" data-key="t-p-list"
                            >Projects List</a
                          >
                        </li>
                        <li>
                          <a
                            ...
                            data-key="t-p-overview"
                            >Project Overview</a
                          >
                        </li>
                        <li>
                          <a href="projects-create.html" data-key="t-create-new"
                            >Create New</a
                          >
                        </li>
                      </ul>
                    ...
                    <li>
                      <a href="layout-vertical.html" class="active">
                        <i class="bx bx-layout nav-icon"></i>
                        <span class="menu-item" data-key="t-verfical"
                          >Vertical</span
                        >
                      </a>
                    </li>
                      ...
                      <ul class="sub-menu mm-collapse" aria-expanded="true">
                        ...
                        <li>
                          ...
                          <ul class="sub-menu mm-collapse" aria-expanded="true">
                            <li>
                              <a
                                href="auth-forgotpassword-basic.html"
                                data-key="t-basic"
                                >Basic</a
                              >
                            </li>
                            <li>
                              <a
                                href="auth-forgotpassword-cover.html"
                                data-key="t-cover"
                                >Cover</a
                              >
                            </li>
                        ...
                        <li>
                          ...
                          <ul class="sub-menu mm-collapse" aria-expanded="true">
                            ...
                            <li>
                              <a
                                href="auth-resetpassword-cover.html"
                                data-key="t-cover"
                                >Cover</a
                              >
                            </li>
                        ...
                        <li>
                          ...
                          <ul class="sub-menu mm-collapse" aria-expanded="true">
                            <li>
                              <a
                                href="auth-emailverification-basic.html"
                                data-key="t-basic"
                                >Basic</a
                              >
                            </li>
                            <li>
                              <a
                                href="auth-emailverification-cover.html"
                                data-key="t-cover"
                                >Cover</a
                              >
                            </li>
                        ...
                        <li>
                          ...
                          <ul class="sub-menu mm-collapse" aria-expanded="true">
                            <li>
                              <a href="auth-2step-basic.html" data-key="t-basic"
                                >Basic</a
                              >
                            </li>
                            <li>
                              <a href="auth-2step-cover.html" data-key="t-cover"
                                >Cover</a
                              >
                            </li>
                          </ul>
                    ...
                    <li>
                      ...
                      >
                        ...
                        <span class="menu-item" data-key="t-error-pages"
                          >Error Pages</span
                        >
                      </a>
                      <ul class="sub-menu mm-collapse" aria-expanded="true">
                        <li>
                          <a
                            ...
                            data-key="t-error-404-basic"
                            >404 Basic</a
                          >
                        </li>
                        <li>
                          <a
                            href="error-404-cover.html"
                            data-key="t-error-404-cover"
                            >404 Cover</a
                          >
                        </li>
                        <li>
                          <a
                            ...
                            data-key="t-error-500-basic"
                            >500 Basic</a
                          >
                        </li>
                        <li>
                          <a
                            href="error-500-cover.html"
                            data-key="t-error-500-cover"
                            >500 Cover</a
                          >
                        </li>
                      </ul>
                    ...
                    <li>
                      ...
                      >
                        ...
                        <span class="menu-item" data-key="t-utility"
                          >Utility</span
                        >
                      </a>
                      <ul class="sub-menu mm-collapse" aria-expanded="false">
                        ...
                        <li>
                          <a href="pages-profile.html" data-key="t-profile"
                            >Profile</a
                          >
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="pages-faqs.html" data-key="t-faqs">FAQs</a>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li>
                      ...
                      >
                        ...
                        <span class="menu-item" data-key="t-pricing"
                          >Pricing</span
                        >
                      </a>
                      <ul class="sub-menu mm-collapse" aria-expanded="false">
                        <li>
                          <a href="pricing-basic.html" data-key="t-basic"
                            >Basic</a
                          >
                        </li>
                        <li>
                          <a href="pricing-table.html" data-key="t-table"
                            >Table</a
                          >
                        </li>
                      </ul>
                    ...
                    <li>
                      ...
                      <ul class="sub-menu mm-collapse" aria-expanded="false">
                        <li>
                          <a href="invoices-list.html" data-key="t-invoice-list"
                            >Invoice List</a
                          >
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      >
                        ...
                        <span class="menu-item" data-key="t-timeline"
                          >Timeline</span
                        >
                      </a>
                      <ul class="sub-menu mm-collapse" aria-expanded="false">
                        ...
                        <li>
                          <a href="timeline-left.html" data-key="t-left-view"
                            >Left View</a
                          >
                        </li>
                      </ul>
                    ...
                    <li class="menu-title" data-key="t-components">
                      Components
                    </li>
                    ...
                    <li>
                      ...
                      >
                        ...
                        <span class="menu-item" data-key="t-ui-elements"
                          >UI Elements</span
                        >
                      </a>
                      <ul class="sub-menu mm-collapse" aria-expanded="false">
                        ...
                        <li>
                          <a href="ui-cards.html" data-key="t-cards">Cards</a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="ui-grid.html" data-key="t-grid">Grid</a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="ui-video.html" data-key="t-video">Video</a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="ui-utilities.html" data-key="t-utilities"
                            >Utilities</a
                          >
                        </li>
                      </ul>
                    ...
                    <li>
                      ...
                      >
                        ...
                        <span class="menu-item" data-key="t-extend-ui"
                          >Extended UI</span
                        >
                      </a>
                      <ul class="sub-menu mm-collapse" aria-expanded="false">
                        ...
                        <li>
                          <a
                            href="extended-swiperslider.html"
                            data-key="t-swiperslider"
                            >Swiper Slider</a
                          >
                        </li>
                      </ul>
                    ...
                    <li>
                      ...
                      <ul class="sub-menu mm-collapse" aria-expanded="false">
                        ...
                        <li>
                          <a href="form-validation.html" data-key="t-validation"
                            >Validation</a
                          >
                        </li>
                        <li>
                          <a
                            ...
                            data-key="t-advanced-plugins"
                            >Advanced Plugins</a
                          >
                        </li>
                        <li>
                          <a href="form-editors.html" data-key="t-editors"
                            >Editors</a
                          >
                        </li>
                        <li>
                          <a href="form-uploads.html" data-key="t-file-upload"
                            >File Upload</a
                          >
                        </li>
                        <li>
                          <a href="form-wizard.html" data-key="t-wizard"
                            >Wizard</a
                          >
                        </li>
                        <li>
                          <a href="form-mask.html" data-key="t-mask">Mask</a>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li>
                      ...
                      >
                        ...
                        <span class="menu-item" data-key="t-tables"
                          >Tables</span
                        >
                      </a>
                      <ul class="sub-menu mm-collapse" aria-expanded="false">
                    ...
                    <li>
                      ...
                      >
                        ...
                        <span class="menu-item" data-key="t-apex-charts"
                          >Apex Charts</span
                        >
                      </a>
                      <ul class="sub-menu mm-collapse" aria-expanded="false">
                        <li>
                          <a href="charts-line.html" data-key="t-line">Line</a>
                        </li>
                        <li>
                          <a href="charts-area.html" data-key="t-area">Area</a>
                        </li>
                        <li>
                          <a href="charts-column.html" data-key="t-column"
                            >Column</a
                          >
                        </li>
                        <li>
                          <a href="charts-bar.html" data-key="t-bar">Bar</a>
                        </li>
                        <li>
                          <a href="charts-mixed.html" data-key="t-mixed"
                            >Mixed</a
                          >
                        </li>
                        <li>
                          <a href="charts-timeline.html" data-key="t-timeline"
                            >Timeline</a
                          >
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="charts-boxplot.html" data-key="t-boxplot"
                            >Boxplot</a
                          >
                        </li>
                        <li>
                          <a href="charts-bubble.html" data-key="t-bubble"
                            >Bubble</a
                          >
                        </li>
                        <li>
                          <a href="charts-scatter.html" data-key="t-scatter"
                            >Scatter</a
                          >
                        </li>
                        <li>
                          <a href="charts-heatmap.html" data-key="t-heatmap"
                            >Heatmap</a
                          >
                        </li>
                        <li>
                          <a href="charts-treemap.html" data-key="t-treemap"
                            >Treemap</a
                          >
                        </li>
                        <li>
                          <a href="charts-pie.html" data-key="t-pie">Pie</a>
                        </li>
                        <li>
                          <a href="charts-radialbar.html" data-key="t-radialbar"
                            >Radialbar</a
                          >
                        </li>
                        <li>
                          <a href="charts-radar.html" data-key="t-radar"
                            >Radar</a
                          >
                        </li>
                        <li>
                          <a href="charts-polararea.html" data-key="t-polararea"
                            >Polararea</a
                          >
                        </li>
                      </ul>
                    ...
                    <li>
                      ...
                      <ul class="sub-menu mm-collapse" aria-expanded="false">
                        <li>
                          <a href="icons-unicons.html" data-key="t-unicons"
                            >Unicons</a
                          >
                        </li>
                        <li>
                          <a
                            href="icons-feathericons.html"
                            data-key="t-feather-icons"
                            >Feather icons</a
                          >
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      <ul class="sub-menu mm-collapse" aria-expanded="false">
                        <li>
                          <a href="maps-google.html" data-key="t-google"
                            >Google</a
                          >
                        </li>
                        <li>
                          <a href="maps-vector.html" data-key="t-vector"
                            >Vector</a
                          >
                        </li>
                        <li>
                          <a href="maps-leaflet.html" data-key="t-leaflet"
                            >Leaflet</a
                          >
                        </li>
                      </ul>
                    ...
                    <li>
                      ...
                      >
                        ...
                        <span class="menu-item" data-key="t-multi-level"
                          >Multi Level</span
                        >
                      </a>
                      <ul class="sub-menu mm-collapse" aria-expanded="true">
        ...
        <div
          ...
          style="width: auto; height: 1285px"
        ></div>
      </div>
      <div
...
import { configTheme } from "@/theme/js/app.js";
